...
import { addFilters, getAllOrders } from "../../features/orders/orderSlice";
...
function Dashboard() {
  ...
  //   // let newArr = [];
  //   // for (let item in itemTypeStats) {
  //   //   newArr.push({ [item]: itemTypeStats[item] });
  //   // }
  //   // console.log(newArr);
  ...
  }, [itemTypeFilter, orderStateFilter]);
